...
const uint8_t num_mxn_blocks_wide_lookup[BLOCK_SIZES] =
  {16, 16, 8, 8, 8, 4, 4, 4, 2, 2, 2, 1, 1};
const uint8_t num_mxn_blocks_high_lookup[BLOCK_SIZES] =
  {16, 8, 16, 8, 4, 8, 4, 2, 4, 2, 1, 2, 1};
